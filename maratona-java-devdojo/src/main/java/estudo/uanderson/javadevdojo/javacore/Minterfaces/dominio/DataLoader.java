...
public interface DataLoader {
    ...
    public static final int MAX_DATE_SIZE = 10; // Por padrão, é public static final
   ...
   public default void checkPermission(){
       ...
       /*
       Metodos com default, significa que a implementação nas classes concretas, não são obrigatórias. Essa é uma solução para a escalabilidade do código/interface que o sistema utiliza. 
       */
   };
   ...
   public static void retrieveMaxDataSize(){
    ...
    - INTERFACE É VISTA COMO UM CONTRATO ESTABELECIDO ENTRE AS CLASSSE QUE DEVE SER RESPEITADO. LODO É CRIADA PARA ALGUÉM IMPLEMENTAR, PORTANTO, NÃO PODE SER PRIVADAS.

    - QUANDO ADICIONAMOS MÉTODOS A INTERFACES, DEVEMOS IMPLEMENTAR ESSE NOVO MÉTODO EM TODAS AS CLASSES QUE UTLIZIAM/IMPLENTAM A INTERFACE.

    NO ENTANTO, ESSA PRÁTICA QUANDO SE TRATA DE SCALABILIDADE, NÃO É A MAIS ADEQUADA, PORTANDO, SEMPRE QUE SE PRECISAR CRIAR NOVOS MÉTODOS NAS INTERFACES, DEVE-SE UTILIZAR MÉTODOS CONCRETAS COM A
   ...
   INTERFACES PERMITEM ATINGIR O DESACOPLAMENTO
